...
%
%\begin{figure}[htbp]
%\centerline{\includegraphics[width=5.0in,angle=0]{zp14tev-ref.pdf}}
%\vspace*{-2.5cm}
%\centerline{\includegraphics[width=5.0in,angle=0]{scaled-ratio.pdf}}
%\vspace*{-1.30cm}
...
%
%\begin{figure}[htbp]
%\centerline{\includegraphics[width=5.0in,angle=0]{zp27tev-ref.pdf}}
%\vspace*{-1.30cm}
...
%
%\begin{figure}[htbp]
%\centerline{\includegraphics[width=5.0in,angle=0]{compare2.pdf}}
%\vspace*{-2.5cm}
%\centerline{\includegraphics[width=5.0in,angle=0]{compare3.pdf}}
%\vspace*{-1.30cm}
